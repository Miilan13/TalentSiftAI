...
const Footer = () => {
  ...
  const navigation = {
    ...
    employers: [
      { name: 'Post a Job', href: '/hr/jobs' },
      { name: 'AI Resume Analysis', href: '#' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">TalentSift AI</span>
            </div>
            <p className="text-gray-400 mb-6 max-w-md">
              Revolutionizing HR recruitment with AI-powered resume analysis. 
              Connect the best candidates with top companies through intelligent matching.
            </p>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3 text-gray-400">
                ...
                <span>contact@talentsiftai.com</span>
              </div>
              <div className="flex items-center space-x-3 text-gray-400">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="text-gray-400 text-sm">
              © {currentYear} TalentSift AI. All rights reserved.
            </div>
